...
export const LANDING_PAGES: Record<string, LandingPageData> = {
  es: {
    ...
    metaDescription: 'Registra tu marca ante el IMPI de forma rápida, asequible y 100% en línea. Precios transparentes desde USD $270 por clase. Presentación en 24 horas hábiles.',
    h1: 'Registra tu marca en México ante el IMPI',
    valueProposition: 'La plataforma más completa para registrar tu marca en México: IA para clasificación, presentación en 24 horas hábiles y precios todo incluido.',
  ...
  en: {
    ...
    metaDescription: 'Register your trademark in Mexico with IMPI quickly and affordably. AI-powered classification, 24-hour filing, all fees included from USD $270 per class.',
    h1: 'Register a Trademark in Mexico with IMPI',
    valueProposition: 'The fastest and most affordable way to file a Mexico trademark — AI-powered classification, transparent pricing, and 24-hour IMPI submission.',
  ...
  zh: {
    ...
    metaDescription: '在线快速注册墨西哥商标，IMPI官方申请，24小时内提交，含全部官费，每类仅需USD $270。AI智能分类，全程中文服务。',
    h1: '墨西哥商标注册 — IMPI在线申请',
    valueProposition: '专为中国跨境卖家打造：AI智能分类、24小时内向IMPI提交申请、含全部官费的透明定价。',
    ctaLabel: '立即申请商标注册',
  ...
  pt: {
    ...
    metaDescription: 'Registre sua marca no México junto ao IMPI de forma rápida e acessível. Protocolamos em até 24 horas úteis, com todos os impostos inclusos, a partir de USD $270 por classe.',
    h1: 'Registro de Marca no México — Protocolo IMPI Online',
    valueProposition: 'A forma mais rápida e acessível de registrar sua marca no México: classificação por IA, protocolo em 24 horas úteis e preço com tudo incluído.',
  ...
  de: {
    ...
    metaDescription: 'Marke in Mexiko beim IMPI anmelden — schnell, günstig und vollständig online. Einreichung innerhalb von 24 Geschäftsstunden, Komplettpreis ab USD $270 pro Klasse.',
    h1: 'Markenanmeldung in Mexiko beim IMPI',
    valueProposition: 'Der einfachste Weg zur Markenanmeldung in Mexiko: KI-gestützte Klassifizierung, Einreichung innerhalb von 24 Geschäftsstunden, Komplettpreis inklusive aller Gebühren.',
  ...
  fr: {
    ...
    metaDescription: 'Déposez votre marque au Mexique auprès de l\'IMPI rapidement et à prix accessible. Dépôt en 24 heures ouvrées, tous frais inclus à partir de USD $270 par classe.',
    h1: 'Enregistrement de marque au Mexique — Dépôt IMPI en ligne',
    valueProposition: 'La solution la plus rapide pour protéger votre marque au Mexique : classification par IA, dépôt en 24 heures ouvrées, tarif tout compris.',
  ...
  hi: {
    ...
    metaDescription: 'मेक्सिको में अपना ट्रेडमार्क IMPI के साथ पंजीकृत करें — 24 व्यावसायिक घंटों में दाखिल, सभी शुल्क सहित USD $270 प्रति वर्ग से। Amazon Brand Registry के लिए भी मान्य।',
    h1: 'मेक्सिको में ट्रेडमार्क पंजीकरण — IMPI ऑनलाइन',
    valueProposition: 'भारतीय Amazon विक्रेताओं और निर्यातकों के लिए: AI-संचालित वर्गीकरण, 24 घंटे में IMPI दाखिलगी, और पारदर्शी मूल्य निर्धारण।',
  ...
  ja: {
    ...
    metaDescription: 'メキシコの商標をIMPIにオンラインで登録。AIによる区分分類、24営業時間以内の申請、全費用込みでUSD $270/区分から。Amazon Brand Registryにも対応。',
    h1: 'メキシコ商標登録 — IMPI オンライン申請',
    valueProposition: '日本企業・ブランドのためのメキシコ商標登録サービス：AIによる区分分類、24営業時間以内の申請提出、費用一切込みの透明な価格設定。',
