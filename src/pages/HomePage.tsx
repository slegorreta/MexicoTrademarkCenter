        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <div className="w-full lg:w-1/2">
            <div>
              ...
              <p className="text-sm sm:text-base font-semibold text-gold-400 mb-3 max-w-xl">
                {t('hero.priceSubline')}
              </p>
              <div className="flex flex-wrap gap-2 mb-5">
                <span className="inline-flex items-center gap-1.5 bg-gold-500 text-white text-xs font-bold px-3 py-1.5 rounded-full">
