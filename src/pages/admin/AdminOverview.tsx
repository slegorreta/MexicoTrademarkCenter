...
export default function AdminOverview() {
  ...
  useEffect(() => {
    ...
    ]).then(([allRes, recentRes, paymentsRes]) => {
  ...
  return (
    <div>
      ...
      <div className="bg-navy-900 rounded-2xl p-6 mb-6 text-white">
        ...
        <div className="text-3xl font-bold">${stats.revenue.toLocaleString('en-US', { minimumFractionDigits: 2 })}</div>
        <div className="text-gray-500 text-xs mt-1">USD · Confirmed payments</div>
      </div>
