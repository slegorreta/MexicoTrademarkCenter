    ...
    sections: [
      {
        title: '1. 収集する個人データ',
        paragraphs: [
          '管理者はデータ主体から直接、以下の個人データを収集します：本人確認データ（氏名、国籍、生年月日、公的身分証明書）；連絡先データ（住所、電話番号、メールアドレス）；必要に応じて、財務データ（RFC、税務上の住所）および法人データ（法人名、代表者、委任状）。商標出願の手続きに関連して、管理者はデータ主体が提供する見本、署名、デザイン、その他の書類を処理することがあります。センシティブな個人データは収集しません。',
        ],
      },
      {
        title: '2. 処理の目的',
        paragraphs: [
          '必要な目的（管理者とデータ主体の間の法的関係の発生および履行に不可欠なもの）：（i）メキシコ工業所有権庁（IMPI）その他の管轄当局への商標その他の知的財産出願、異議申立、更新および関連手続の準備・申請・追跡；（ii）データ主体が自らの案件の状況を確認できるオンライン出願管理システムの運営；（iii）請求書の発行、支払いの管理および法的文書の送付；（iv）法令上・規制上・契約上の義務の遵守。',
          '任意の目的（法的関係に不可欠でないもの）：管理者のサービスに関する情報提供およびマーケティング、クライアントアラート、業界ニュースの送信。データ主体はinfo@mexicotrademarkcenter.comへのメールにより、いつでも任意の目的に異議を申し立てることができます。',
        ],
      },
      {
        title: '3. 第三者への提供',
        paragraphs: [
          '管理者は以下の者に個人データを提供することがあります：（i）出願・手続の追跡に関連する IMPI、裁判所その他の管轄当局；（ii）国際またはメキシコ以外の法域における商標手続が必要な場合の外国代理人および提携弁護士；（iii）機密保持およびデータ保護義務を負うサービス提供者（ホスティング、IT、会計、請求書発行）。LFPDPPPの第22条に規定する提供は、データ主体の同意を必要としません。',
        ],
      },
      {
        title: '4. ARCO権利および同意の撤回',
        paragraphs: [
          'データ主体は、個人データへのアクセス、訂正、削除または処理への異議申立（ARCO権利）、同意の撤回、データの利用または開示の制限を行う権利を有します。これらの権利を行使するには、info@mexicotrademarkcenter.comに以下を記載した書面による請求を送付してください：（i）氏名および回答を受け取る手段；（ii）本人確認または必要に応じて代理権を証明する書類；（iii）対象となる個人データおよび行使する権利の明確な説明；（iv）データの特定に役立てるその他の事項。管理者はLFPDPPPに定める法定期限内に回答します。',
        ],
      },
      {
        title: '5. CookieおよびオンラインDocketシステム',
        paragraphs: [
          'ウェブサイトおよびオンラインDocketシステムは、ユーザーの認証、各ユーザーのDocketへの安全なアクセスの確保および機能の提供のために、Cookieおよび類似の技術を使用しています。データ主体はブラウザを通じてCookieを無効にすることができますが、その場合Docketシステムへのアクセスが制限される場合があります。',
        ],
      },
      {
        title: '6. プライバシーポリシーの変更',
        paragraphs: [
          '本プライバシーポリシーへの変更はウェブサイトを通じてお知らせします。データ主体はその内容を定期的に確認する責任を負います。',
        ],
      },
    ],
  },
