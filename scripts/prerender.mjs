...
const PAGES = {
  es: {
    bcp47: 'es',
    title: 'Registro de Marca en México | IMPI Online — MexicoTrademarkCenter',
    desc: 'Registra tu marca ante el IMPI de forma rápida, asequible y 100% en línea. Precios transparentes desde USD $270 por clase. Presentación en 24 horas hábiles.',
    h1: 'Registra tu marca en México ante el IMPI',
    valueProp: 'La plataforma más completa para registrar tu marca en México: IA para clasificación, presentación en 24 horas hábiles y precios todo incluido.',
    ...
    bullets: [
      ...
      'Precio todo incluido: USD $270 por clase cubre honorarios de servicio y tasas oficiales del IMPI. Sin sorpresas.',
    ...
    testimonials: [
      ...
      { quote: 'Excelente relación calidad-precio. Por USD $270 obtuve un servicio profesional que en un despacho me hubiera costado el triple.', author: 'Sofía L.', role: 'Directora de operaciones — Monterrey, México' },
    ],
    faqs: [
      ...
      { q: '¿Cuánto cuesta registrar una marca en México?', a: 'Nuestro precio es de USD $270 por clase, todo incluido: honorarios de servicio (USD $100) y tasas oficiales del IMPI (USD $170).' },
    ...
    price: 'USD $270 por clase',
  },
  en: {
    bcp47: 'en',
    title: 'Register Trademark in Mexico Online | IMPI Filing — MexicoTrademarkCenter',
    desc: 'Register your trademark in Mexico with IMPI quickly and affordably. AI-powered classification, 24-hour filing, all fees included from USD $270 per class.',
    h1: 'Register a Trademark in Mexico with IMPI',
    valueProp: 'The fastest and most affordable way to file a Mexico trademark — AI-powered classification, transparent pricing, and 24-hour IMPI submission.',
    ...
    faqs: [
      ...
      { q: 'How much does it cost to register a trademark in Mexico?', a: 'USD $270 per class, all-inclusive: service fee USD $100 plus IMPI government fees USD $170.' },
    ...
    price: 'USD $270 per class',
  },
  zh: {
    bcp47: 'zh-Hans',
    title: '墨西哥商标注册 | IMPI在线申请 — MexicoTrademarkCenter',
    desc: '在线快速注册墨西哥商标，IMPI官方申请，24小时内提交，含全部官费，每类仅需USD $270。AI智能分类，全程中文服务。',
    h1: '墨西哥商标注册 — IMPI在线申请',
    valueProp: '专为中国跨境卖家打造：AI智能分类、24小时内向IMPI提交申请、含全部官费的透明定价。',
    cta: '立即申请商标注册',
    bodyH1: '为什么在墨西哥注册商标？',
    ...
    bullets: [
      ...
      '全包价格透明：每类USD $270，含服务费（USD $100）和IMPI官方注册费（USD $170）。',
    ...
    faqs: [
      ...
      { q: '墨西哥商标注册费用是多少？', a: '我们的全包价格为每类USD $270，包含服务费USD $100和IMPI官方注册费USD $170。' },
  ...
  pt: {
    bcp47: 'pt',
    title: 'Registro de Marca no México | Protocolo IMPI Online — MexicoTrademarkCenter',
    desc: 'Registre sua marca no México junto ao IMPI de forma rápida e acessível. Protocolamos em até 24 horas úteis, com todos os impostos inclusos, a partir de USD $270 por classe.',
    h1: 'Registro de Marca no México — Protocolo IMPI Online',
    valueProp: 'A forma mais rápida e acessível de registrar sua marca no México: classificação por IA, protocolo em 24 horas úteis e preço com tudo incluído.',
    ...
    bullets: [
      ...
      'Preço com tudo incluído: USD $270 por classe cobre honorários e taxas oficiais do IMPI. Sem surpresas.',
    ...
    faqs: [
      ...
      { q: 'Quanto custa o registro de marca no México?', a: 'USD $270 por classe, tudo incluído: honorários (USD $100) e taxas oficiais do IMPI (USD $170).' },
    ...
    price: 'USD $270 por classe',
  },
  de: {
    bcp47: 'de',
    title: 'Markenanmeldung in Mexiko | IMPI Online — MexicoTrademarkCenter',
    desc: 'Marke in Mexiko beim IMPI anmelden — schnell, günstig und vollständig online. Einreichung innerhalb von 24 Geschäftsstunden, Komplettpreis ab USD $270 pro Klasse.',
    h1: 'Markenanmeldung in Mexiko beim IMPI',
    valueProp: 'Der einfachste Weg zur Markenanmeldung in Mexiko: KI-gestützte Klassifizierung, Einreichung innerhalb von 24 Geschäftsstunden, Komplettpreis inklusive aller Gebühren.',
    ...
    bullets: [
      ...
      'Komplettpreis: USD $270 pro Klasse deckt Service- und IMPI-Gebühren. Keine versteckten Kosten.',
    ...
    faqs: [
      ...
      { q: 'Was kostet eine Markenanmeldung in Mexiko?', a: 'USD $270 pro Klasse (Servicegebühr USD $100 + IMPI-Gebühren USD $170).' },
    ...
    price: 'USD $270 pro Klasse',
  },
  fr: {
    bcp47: 'fr',
    title: 'Enregistrement de marque au Mexique | Dépôt IMPI en ligne — MexicoTrademarkCenter',
    desc: "Déposez votre marque au Mexique auprès de l'IMPI rapidement et à prix accessible. Dépôt en 24 heures ouvrées, tous frais inclus à partir de USD $270 par classe.",
    h1: 'Enregistrement de marque au Mexique — Dépôt IMPI en ligne',
    valueProp: 'La solution la plus rapide pour protéger votre marque au Mexique : classification par IA, dépôt en 24 heures ouvrées, tarif tout compris.',
    ...
    bullets: [
      ...
      "Tarif tout compris : USD $270 par classe couvre les honoraires et les taxes officielles de l'IMPI. Aucun frais caché.",
    ...
    faqs: [
      ...
      { q: "Quel est le coût d'enregistrement d'une marque au Mexique ?", a: "USD $270 par classe : honoraires (USD $100) + taxes IMPI (USD $170)." },
    ...
    price: 'USD $270 par classe',
  },
  hi: {
    bcp47: 'hi',
    title: 'मेक्सिको में ट्रेडमार्क पंजीकरण | IMPI ऑनलाइन — MexicoTrademarkCenter',
    desc: 'मेक्सिको में अपना ट्रेडमार्क IMPI के साथ पंजीकृत करें — 24 व्यावसायिक घंटों में दाखिल, सभी शुल्क सहित USD $270 प्रति वर्ग से। Amazon Brand Registry के लिए भी मान्य।',
    h1: 'मेक्सिको में ट्रेडमार्क पंजीकरण — IMPI ऑनलाइन',
    valueProp: 'भारतीय Amazon विक्रेताओं और निर्यातकों के लिए: AI-संचालित वर्गीकरण, 24 घंटे में IMPI दाखिलगी, और पारदर्शी मूल्य निर्धारण।',
    cta: 'अभी आवेदन करें',
    ...
    bullets: [
      ...
      'सर्व-समावेशी मूल्य: USD $270 प्रति वर्ग में सेवा शुल्क और IMPI आधिकारिक शुल्क दोनों शामिल हैं।',
    ...
    faqs: [
      ...
      { q: 'मेक्सिको में ट्रेडमार्क पंजीकरण की लागत कितनी है?', a: 'USD $270 प्रति वर्ग: सेवा शुल्क USD $100 + IMPI आधिकारिक शुल्क USD $170।' },
    ...
    price: 'USD $270 प्रति वर्ग',
  },
  ja: {
    bcp47: 'ja',
    title: 'メキシコ商標登録 | IMPI オンライン申請 — MexicoTrademarkCenter',
    desc: 'メキシコの商標をIMPIにオンラインで登録。AIによる区分分類、24営業時間以内の申請、全費用込みでUSD $270/区分から。Amazon Brand Registryにも対応。',
    h1: 'メキシコ商標登録 — IMPI オンライン申請',
    valueProp: '日本企業・ブランドのためのメキシコ商標登録サービス：AIによる区分分類、24営業時間以内の申請提出、費用一切込みの透明な価格設定。',
    cta: '今すぐ商標登録を申請する',
    ...
    bullets: [
      ...
      '全費用込み価格：1区分USD $270でサービス料とIMPI公式登録費用がすべて含まれます。',
    ...
    testimonials: [
      ...
      { quote: '全費用込みのUSD $270という価格は非常に透明で、代理人を使った場合の数分の1のコストです。', author: '山本 K.', role: 'IP担当マネージャー、化粧品会社 — 名古屋、日本' },
    ],
    faqs: [
      { q: '日本企業や個人はメキシコで商標登録できますか？', a: 'はい。いかなる国籍の個人・法人もIMPIに直接出願できます。' },
      { q: 'メキシコ商標登録の費用はいくらですか？', a: '1区分あたりUSD $270（全費用込み）：サービス料USD $100 + IMPI公式登録費USD $170。' },
