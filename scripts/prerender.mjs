...
const PAGES = {
  ...
  en: {
    ...
    valueProp: 'The most affordable way to file a Mexico trademark — AI-powered classification, all fees included from USD $270 per class, 24-hour IMPI submission.',
  ...
  pt: {
    ...
    valueProp: 'A forma mais acessível de registrar sua marca no México: classificação por IA, todos os impostos inclusos a partir de USD $270 por classe, protocolo em 24 horas úteis.',
  ...
  fr: {
    ...
    valueProp: 'La solution la plus abordable pour enregistrer votre marque au Mexique : classification par IA, tous frais inclus dès USD $270 par classe, dépôt en 24 heures ouvrées.',
  ...
  hi: {
    ...
    valueProp: 'भारतीय Amazon विक्रेताओं और निर्यातकों के लिए किफायती समाधान: AI-संचालित वर्गीकरण, USD $270 प्रति वर्ग सर्व-समावेशी, 24 घंटे में IMPI दाखिलगी।',
    cta: 'अभी आवेदन करें',
  ...
  ja: {
    ...
    valueProp: '日本企業・ブランドのための低コストなメキシコ商標登録：AIによる区分分類、全費用込みUSD $270/区分、24営業時間以内のIMPI申請提出。',
    cta: '今すぐ商標登録を申請する',
